...
export const YoutubePlayer: React.FC = () => {
    const [youtubeCurrentSong, _setYoutubeCurrentSong] = useReplicant<any, youtubeCurrentSong>('youtubeCurrentSong', firstSong);
    const [youtubePlayPause, setYoutubePlayPause] = useReplicant<any, boolean>('youtubePlayPause', true);
    const [youtubeMute, _setYoutubeMute] = useReplicant<any, boolean>('youtubeMute', false);
    const [youtubeVolume, _setYoutubeVolume] = useReplicant<any, number>('youtubeVolume', 10);
    ...
    const [currentSong, setCurrentSong] = useState<string>('https://youtu.be/dQw4w9WgXcQ');
